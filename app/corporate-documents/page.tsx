    ...
    <div className="min-h-screen bg-sand text-earth">
      ...
      <main className="max-w-5xl mx-auto px-4 py-16 space-y-12">
        ...
        <div className="space-y-4">
          ...
          <p className="text-earth/70 text-lg max-w-2xl leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-white p-8 rounded-2xl border border-earth/10 shadow-sm flex flex-col justify-between space-y-6 hover:shadow-md transition">
            <div className="space-y-4">
            ...
            <a
              ...
              download
              target="_blank"
              className="inline-flex items-center justify-center w-full py-3.5 px-5 bg-ochre hover:bg-ochre-dark  text-sm font-semibold rounded-xl transition shadow-sm hover:shadow gap-2 text-center"
            >
          ...
          <div className="bg-white p-8 rounded-2xl border border-earth/10 shadow-sm flex flex-col justify-between space-y-6 hover:shadow-md transition">
            ...
            <a
              ...
              download
              target="_blank"
              className="inline-flex items-center justify-center w-full py-3.5 px-5 bg-earth hover:bg-earth-dark  text-sm font-semibold rounded-xl transition shadow-sm hover:shadow gap-2 text-center"
            >
