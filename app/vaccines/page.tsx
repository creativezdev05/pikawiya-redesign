    ...
    <div className="min-h-screen bg-sand text-earth">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 space-y-10">
        ...
        <div className="space-y-3 text-center max-w-2xl mx-auto">
          ...
          <p className="text-earth/70 text-base md:text-lg">
        ...
        <div className="bg-white p-8 md:p-10 rounded-3xl border border-earth/10 shadow-sm space-y-8">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sand text-earth/80 text-xs font-medium border border-earth/10">
              <span className="w-2 h-2 rounded-full bg-ochre" />
              Current Status: No Active Advertised Vacancies
            </div>

            <p className="text-earth/80 text-base md:text-lg leading-relaxed">
          ...
          <div className="border-t border-earth/10 pt-8 space-y-6">
            ...
            <div className="bg-sand/50 p-6 rounded-2xl border border-earth/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-ochre/10 text-ochre flex items-center justify-center shrink-0">
                  <Mail className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-xs text-earth/60 font-medium">Send applications to</p>
                  <a
                    href="mailto:generalenquiries@pikawiyahealth.org.au"
                    className="text-earth font-bold text-base hover:text-ochre transition"
                  >
            ...
            <p className="text-earth/70 text-sm leading-relaxed italic">
