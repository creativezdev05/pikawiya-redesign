    ...
    <div className="relative min-h-screen bg-page text-ink flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-4xl mx-auto px-4 py-12 md:py-16 space-y-10">
          ...
          <div className="bg-surface p-8 md:p-12 rounded-3xl border border-border shadow-sm space-y-8">
            ...
            <section className="bg-page p-6 rounded-2xl border border-border space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 text-ink font-semibold text-sm hover:text-ochre transition"
                >
